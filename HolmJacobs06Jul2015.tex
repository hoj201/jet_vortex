...
%We will begin by considering standard vortex blobs, which we will find comprise the $0$th order jet vortices.
...
%Consider now the following 1st order jet vortex solution ansatz for the vorticity
%\begin{align}
