...
\subsection{A jet-vortex perturbation of a known solution}
\label{sec:triangle}
...
We then obtained equations of motion for jet vortices in the same way that vortex
blob equations of motion are derived.

The extra degrees of freedom of jet-vortices resulted in richer dynamics near the vortex core.
Moreover, these new vortices exhibited a variety of interesting behavior, including the ability
to achieve faster convergence rates using higher order jet vortices,
as well as decrease the number of pairwise interactions, by grouping.
Moreover, the manifestation of Kelvin's circulation theorem was substantially richer in the case of jet-vortices.
