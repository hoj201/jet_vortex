...
\end{align}
where $\omega = \Delta \psi$ and $\psi$ is the stream function.
...
In this article we study the more general ansatz $\omega = \sum_i \Gamma_i^{mn} \partial_x^m \partial_y^n \delta_{z_i}$.
