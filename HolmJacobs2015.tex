...
where $\Gamma_i \in \mathbb{R}$, $z=(x,y) \in \mathbb{R}^2$ and $\delta_{z_i}$ is the Dirac delta distribution centered at the point $z_i = (x_i,y_i) \in \mathbb{R}^2$.
...
\section{Moments}
\label{sec:moments}
	\todo[inline]{I think this section needs the justification.  I understand that it is cool that we obtain a closed system for the moments, which is new.  However, I don't understand why moments are important.}
	...
	However, that the equations of motion for the moments forms a closed system at order $N$
...
The multiscale nature of ideal fluids is the principal obstacle to obtaining accurate models.\todo{Cite something}
